...
class ResponseMessage extends $pb.GeneratedMessage {
  ...
  factory ResponseMessage.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ResponseMessage.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ResponseMessage',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'email_support'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'supportRequestSent',
        protoName: 'supportRequestSent')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ResponseMessage clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set supportRequestSent($core.bool value) => $_setBool(0, value);
  @$pb.TagNumber(1)
  $core.bool hasSupportRequestSent() => $_has(0);
  @$pb.TagNumber(1)
  void clearSupportRequestSent() => $_clearField(1);
}
