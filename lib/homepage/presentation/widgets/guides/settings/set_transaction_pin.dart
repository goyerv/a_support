...
class SetTransactionPin extends StatefulWidget {
  ...
  const SetTransactionPin(this.onLocaleChanged, this.locale, {Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () => Share.share("https://support.goyerv.com/${widget.locale}/guides/settings/set-transaction-pin.html"),
                        child: Container(
                    ...
                    Row(
                      children: [
                        ...
                        OutlinedButton(
                          onPressed: () => BlocProvider.of<GuidesBloc>(context).add(RateGuideEvent("2025/settings/7", true)),
                        ...
                        OutlinedButton(
                          onPressed: () => BlocProvider.of<GuidesBloc>(context).add(RateGuideEvent("2025/settings/7", false)),
                          style: OutlinedButton.styleFrom(
                            side: BorderSide(color: grey),
                            shape: StadiumBorder(),
                            backgroundColor: transparent,
