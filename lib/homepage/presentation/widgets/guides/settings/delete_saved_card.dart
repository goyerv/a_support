...
class HowDoIDeleteSavedCard extends StatefulWidget {
  ...
  const HowDoIDeleteSavedCard(this.onLocaleChanged, this.locale, {Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () => Share.share("https://support.goyerv.com/${widget.locale}/guides/settings/how-do-I-delete-a-saved-card.html"),
                        child: Container(
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(text: AppLocalizations.of(context).translate('Remove any linked debit or credit cards you no longer want saved.\n\n')),
                    ...
                    Row(
                      children: [
                        ...
                        OutlinedButton(
                          onPressed: () => BlocProvider.of<GuidesBloc>(context).add(RateGuideEvent("2025/settings/3", true)),
                        ...
                        OutlinedButton(
                          onPressed: () => BlocProvider.of<GuidesBloc>(context).add(RateGuideEvent("2025/settings/3", false)),
                          style: OutlinedButton.styleFrom(
                            side: BorderSide(color: grey),
                            shape: StadiumBorder(),
                            backgroundColor: transparent,
