...
class WhatDoLocksMean extends StatefulWidget {
  ...
  const WhatDoLocksMean(this.onLocaleChanged, this.locale, {Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () => Share.share("https://support.goyerv.com/${widget.locale}/guides/wallet/what-do-the-locks-on-my-account-mean.html"),
                        child: Container(
