...
class WhatDoLocksMean extends StatefulWidget {
  ...
  const WhatDoLocksMean(this.onLocaleChanged, {Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () => Share.share("https://support.goyerv.com/guides/wallet/what-do-the-locks-on-my-account-mean.html"),
                        child: Container(
